About terraform-provider-cloudinit-feedstock
============================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-cloudinit-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-cloudinit-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-cloudinit
# for installing globally
pixi global install terraform-provider-cloudinit
```
...
It is possible to list all of the versions of `terraform-provider-cloudinit` available on your platform:
...
```
pixi search terraform-provider-cloudinit --channel conda-forge
```
